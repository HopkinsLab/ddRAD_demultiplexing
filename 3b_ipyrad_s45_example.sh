...
#SBATCH -o c3_93_s45_%A.out      # File to which STDOUT will be written
#SBATCH -e c3_93_s45_%A.err      # File to which STDERR will be written
...
ipyrad -p params-c3_clust93_req4.txt -s 45